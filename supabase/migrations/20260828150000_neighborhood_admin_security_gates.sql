-- Every NEIGHBORHOOD_ADMIN manages residentes, guardias and barreras de su barrio,
-- esté o no dentro de un complejo.
...
create policy user_roles_select on public.user_roles
  ...
  using (
    ...
    or (
      role = 'SECURITY'
      and (public.is_complex_admin() or public.is_neighborhood_admin())
    )
  );
