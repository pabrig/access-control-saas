  ...
  return (
    <>
      <PageHeader
        ...
        description={
          barrio
            ? "La puerta de tu barrio. Seguridad escanea acá."
            : "Cada QR se valida en una barrera. La principal es la del complejo; las internas son de cada barrio."
        }
      />
      ...
      <section className={ui.card}>
        ...
        <form action={createGate} className={ui.form}>
          {barrio ? (
            <>
              <input type="hidden" name="type" value="INTERNAL_NEIGHBORHOOD" />
              {neighborhoodId ? (
                <input
                  type="hidden"
          ...
          <label>
            ...
            <input
              ...
              required
              maxLength={80}
              placeholder={barrio ? "Puerta del barrio" : "Barrera principal"}
            />
          </label>
          {barrio ? null : (
            <>
